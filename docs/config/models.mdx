...
| Bedrock                                           | Text foundation models and active inference profile IDs in the configured region. Listing requires a supported fixed credential configuration and permission for both catalog operations.                                  |
