...
**Coder** provider and use the **Discovered models…** dropdown to add the catalog entries you
want, or type any model ID into the free-text field; nothing appears in the model picker until
you add it. Added models survive **Refresh models**, re-logins and **Disconnect**. Removing a
