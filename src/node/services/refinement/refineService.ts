...
interface RefineServiceOptions {
  ...
  emitChatMessage?: (workspaceId: string, message: XumMessage) => void;
  /**
 ...
 */
function fingerprintHistoryRow(row: XumMessage | undefined): string {
...
export function createRefineSummaryMessage(
  ...
  return createXumMessage(createRefineSummaryMessageId(), "assistant", lines.join("\n"), {
    timestamp: Date.now(),
