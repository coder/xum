...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "xum-docs": {
    ...
    "references/docs/getting-started/mux-gateway.mdx": [
      ...
      "tracker](https://github.com/coder/xum/issues).",
      "",
    ].join("\n"),
    ...
    "references/docs/guides/github-actions.mdx": [
      ...
      "",
      "The prompt is stored in a separate file ([`.github/prompts/auto-cleanup.md`](https://github.com/coder/xum/blob/main/.github/prompts/auto-cleanup.md)) and piped via stdin, keeping the workflow file clean and the prompt easy to iterate on.",
      "",
    ...
    "references/docs/index.mdx": [
      ...
      "## License",
      "",
      "Xum is licensed under the [GNU Affero General Public License v3.0 (AGPL-3.0)](https://github.com/coder/xum/blob/main/LICENSE).",
      "",
    ...
    "references/docs/install.mdx": [
      ...
      "### Release Builds",
      "",
      '<Card title="Download Xum" icon="download" href="https://github.com/coder/xum/releases">',
      ...
      "### Development Builds",
      "",
      "Download pre-built binaries of `main` from [GitHub Actions](https://github.com/coder/xum/actions/workflows/pr.yml?query=event:push+branch:main):",
      "",
      ...
      "To download:",
      "",
      "1. Go to the [PR workflow (main branch)](https://github.com/coder/xum/actions/workflows/pr.yml?query=event:push+branch:main)",
      ...
      "",
      "1. Download the installer exe from [releases](https://github.com/coder/xum/releases) (e.g., `xum-x.x.x-x64.exe`)",
      "2. Run the installer",
      ...
      "  issues](https://github.com/coder/xum/issues) you encounter.",
      "</Warning>",
      "",
    ...
    "references/docs/integrations/vscode-extension.mdx": [
      ...
      "",
      "If you hit issues, please report them on the [Xum GitHub issues page](https://github.com/coder/xum/issues).",
      "",
      "## Installation",
      "",
      "### Download",
      "",
      "Download the latest `.vsix` file from the [GitHub releases page](https://github.com/coder/xum/releases).",
      "",
      "### Install",
      "",
      "**Command line:**",
    ...
    "references/docs/reference/telemetry.mdx": [
      ...
      "- **Transparent payload**: See exactly what is sent in [`src/common/telemetry/payload.ts`](https://github.com/coder/xum/blob/main/src/common/telemetry/payload.ts).",
      "",
      "## What Xum tracks",
      "",
      ...
      "## Source code",
      "",
      "- **Payload definitions**: [`src/common/telemetry/payload.ts`](https://github.com/coder/xum/blob/main/src/common/telemetry/payload.ts)",
      "- **Backend service**: [`src/node/services/telemetryService.ts`](https://github.com/coder/xum/blob/main/src/node/services/telemetryService.ts)",
      "- **Frontend client**: [`src/common/telemetry/client.ts`](https://github.com/coder/xum/blob/main/src/common/telemetry/client.ts)",
      "- **Privacy utilities**: [`src/common/telemetry/utils.ts`](https://github.com/coder/xum/blob/main/src/common/telemetry/utils.ts)",
      "",
    ].join("\n"),
