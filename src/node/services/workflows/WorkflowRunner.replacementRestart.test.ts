 ...
 * (a fresh `bun` process on the same Xum root) resumes the run. See replacementRestart.fixture.ts.
 */
...
const FIXTURE = path.join(import.meta.dir, "replacementRestart.fixture.ts");
